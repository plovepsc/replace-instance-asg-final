...
# Example usage:
command_to_run = "cd /home/ubuntus/terarom/finalasgcapcity/desirecapsityincrease && python3 runcommand.py"  # Replace this with your desired command
...
def run_command_with_delay(command, delay_seconds):
    ...
    try:
        # Execute the command using subprocess
        result2 = subprocess.run(command, shell=True, check=True, text=True, capture_output=True)
        print("Command executed successfully.")
        print("Output:")
...
# Example usage:
command_to_run2 = "cd /home/ubuntus/terarom/finalasgcapcity && python3 runcommand.py"  # Replace this with your desired command
delay_seconds = 5  # 2 minutes (2 minutes = 120 seconds)

run_command_with_delay(command_to_run2, delay_seconds)
